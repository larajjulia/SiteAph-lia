...
<body>
    ...
    <h2 class="section-subtitle" style="margin-left: 30px; margin-top: 20px;">
       Sistemas Fotovoltáicos Ongrid
    </h2>
    <p id="ce_description" style="margin-left: 30px">
        Projetamos e instalamos sistemas fotovoltaicos on-grid, que funcionam conectados à rede elétrica.
    </p>

    <p id="ce_text" style="margin-left: 30px"> 
        Essa solução é ideal para residências, comércios e empresas que desejam reduzir a conta de luz e 
        gerar energia de forma sustentável, utilizando a luz solar como fonte principal.<br><br>

        O sistema gera energia durante o dia, consumida em tempo real. O excedente é injetado na rede da 
        concessionária, gerando créditos que podem ser usados em períodos noturnos ou de baixa produção. 
        Todo o processo segue as normas técnicas e regulatórias.<br><br>

        Cuidamos de todas as etapas: análise de viabilidade, dimensionamento do sistema, homologação 
        junto à concessionária, instalação e acompanhamento pós-venda. Garantimos eficiência, segurança 
        e retorno econômico para seu investimento.
    </p>
