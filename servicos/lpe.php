...
<body>
    ...
    <h2 class="section-subtitle" style="margin-left: 30px; margin-top: 20px;">
        Laudos e Prontuários Elétricos
    </h2>
    ...
    <p id="ce_text" style="margin-left: 30px"> 
        Elaboramos Laudos Técnicos e Prontuários das Instalações Elétricas conforme as exigências 
        da norma NR-10, fundamentais para garantir a segurança de trabalhadores e a conformidade 
        legal em ambientes industriais, comerciais e prediais.<br><br>

        O laudo avalia as condições da instalação elétrica, identifica riscos e propõe adequações. 
        Já o prontuário reúne toda a documentação técnica da instalação, incluindo esquemas, 
        procedimentos de segurança e manutenção preventiva.<br><br>

        Esses documentos são obrigatórios em muitas empresas e contribuem para evitar acidentes, 
        autuações e falhas no sistema elétrico. Oferecemos avaliação completa com responsabilidade 
        técnica e emissão da ART.
    </p>
