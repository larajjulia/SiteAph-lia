...
<head>
    ...
    <title>Aphélia - Administrador</title>
...
<body>
    ...
    <main>
        <div id="login_content">
            ...
            <form action="admin/admin-login.php" id="login_form" target="_self" method="post">
            ...
            <div class="footer-links">
                <a href="login.php" class="footer-links">Usuário</a>&nbsp; &nbsp;
                <a href="index.php" class="footer-links">Início</a>&nbsp; &nbsp;
            </div>
        </div>
    </main>
